        ...
        {/* <section id="about" className="about">
          <div className="container">
            ...
            <div className="row content">
              <div className="col-lg-6" data-aos-delay={150}>
                <p>
              ...
              <div className="col-lg-6 pt-4 pt-lg-0" data-aos-delay={300}>
                <p>
          ...
          <div className="container">
            <div className="row">
              <div className="col-md-6 d-flex align-items-stretch">
                <div className="card" style={{ backgroundImage: 'url("assets/img/more-services-1.jpg")' }}>
              ...
              <div className="col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
                <div className="card" style={{ backgroundImage: 'url("assets/img/more-services-2.jpg")' }} data-aos-delay={200}>
                  <div className="card-body">
              ...
              <div className="col-md-6 d-flex align-items-stretch mt-4">
                <div className="card" style={{ backgroundImage: 'url("assets/img/more-services-3.jpg")' }}>
                  <div className="card-body">
              ...
              <div className="col-md-6 d-flex align-items-stretch mt-4">
                <div className="card" style={{ backgroundImage: 'url("assets/img/more-services-4.jpg")' }} data-aos-delay={200}>
                  <div className="card-body">
